...
const ProjectDirectory = () => {
  ...
  const params = useMemo(() => {
    const p = { page: currentPage, scope: 'DESIGN' };
  ...
  return (
    <div>
      {/* 1. العنوان وزر الإضافة ثوابت لا تختفي وقت التحميل */}
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-black">Design Projects</h1>
        {isSecretary && (
          <Link
            to="/projects/create"
      ...
      {/* 2. الفلتر ثابت وتم تمرير initialFilters لكي لا يفقد قيمته */}
      <div className="mb-6">
        <GlobalFilterBar onFilterChange={handleFilterChange} initialFilters={filters} />
      </div>

      {/* 3. التعامل الصحيح مع حالة التحميل (تظهر مكان المشاريع فقط) */}
      {loading ? (
