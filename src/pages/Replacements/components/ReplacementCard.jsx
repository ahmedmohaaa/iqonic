...
const ReplacementCard = ({ request, type, onRespond }) => {
  // تكييف البيانات بناءً على نوع الطلب (Task أو Supervision)
  ...
  const title = isTask ? request.task?.title || request.task?.discipline_name : request.assignment?.role;
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-between space-x-2">
          <div className="flex-1 text-center">
            ...
            <p className="text-xs font-semibold text-gray-800 truncate">{currentEngineer?.first_name} {currentEngineer?.last_name}</p>
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-xs font-semibold text-blue-800 truncate">{suggestedEngineer?.first_name} {suggestedEngineer?.last_name}</p>
